...
<div class="hero-wrapper">
  <picture>
    <source media="(max-width: 767px)" srcset="https://betaplus.org.uk/public/janet3-512x280.jpg">
    <img src="https://betaplus.org.uk/public/pf-banner-512.jpg" alt="BetaPlus Computer Club">
  </picture>
...
rows = ''.join(f'<tr><td>{e["date"]}</td><td>{e["event"]}</td></tr>' for e in events)
html = f'''
...
<div class="accordion" id="accordionClub">
  ...
  <div class="accordion-item">
    ...
    <div id="club3" class="accordion-collapse collapse" data-bs-parent="#accordionClub">
      <div class="accordion-body">
        <p>The annual membership fee is <strong>&pound;50</strong>, running from September to June. This covers all main meetings and study group sessions throughout the year.</p>
      </div>
    </div>
  </div>
